...
class HFModel:
    def __init__(self, model_repo, hf_token):
        ...
        self.chat_template = self._get_chat_template(access_token=hf_token or None)
        self.model_has_chat_template = bool(self.chat_template)
        self.max_length = self._get_max_length()
        
    def _get_chat_template(self, access_token=None):
